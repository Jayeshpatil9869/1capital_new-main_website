                    ...
                    <div className="container grid grid-2">
                        <div>
                            ...
                            <div className="hero-actions">
                                ...
                                <a href="/mutual-funds" className="btn btn-purple btn-lg">MF Solutions</a>
                ...
                <section id="command" className="dark-section">
                    <div className="container grid grid-2 gsap-reveal" style={{ alignItems: 'center' }}>
                        <div>
                            ...
                            <a href="#contact" className="btn btn-purple btn-lg" style={{ marginTop: '1rem' }}>Request Advisory Access</a>
                        </div>
                        ...
                        <div className="grid grid-4" style={{ marginBottom: '6rem' }}>
                            ...
                            <div>
                                ...
                                <ul className="footer-links">
                                    ...
                                    <li><a href="#sip-calculator">Wealth Simulator</a></li>
                                </ul>
                            </div>
                        </div>
